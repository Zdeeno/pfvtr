...
tmux send-keys -t bearnav:bearnav "roslaunch pfvtr jackal.launch "
...
tmux send-keys -t bearnav:resize "rosrun nodelet nodelet standalone image_proc/resize image:=/front/color/image_raw camera_info:=/front/color/camera_info _scale_width:=0.8 _scale_height:=0.8"
